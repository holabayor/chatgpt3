...
const Header = () => (
  <section id="home" className={`flex md:flex-row flex-col`}>
    <div className="absolute right-[50%] top-[30%] z-[-1] header__gradient1"></div>
    <div className={`${styles.flexStart} flex-1 flex-col`}>
      <div className="bg__gradient absolute"></div>
      ...
      <p className={` text-lightBlue sm:text-[20px] text-[16px] sm:leading-7`}>
